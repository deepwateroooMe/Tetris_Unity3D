...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_212322.png}
\begin{itemize}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_212542.png}
\begin{itemize}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_212637.png}

\subsection{选择unityLibrary导入。点击Finish}
\label{sec-2-3}

\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_212720.png}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_220455.png}
\begin{itemize}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_213229.png}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_213646.png}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_213842.png}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_214020.png}
\begin{itemize}
\item 进行这两步操作的原因是，我在运行到手机时，他显示硬件不支持或者闪退。加入上面两个代码后就可以正常启动unity。
\item 我个人认为真正起作用的是上上一步关于手机架构的设置的ndk那三行,与上面字符串无关,应该是无关的
\end{itemize}

\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_215409.png}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_214251.png}
\begin{itemize}
...
\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_214852.png}

\section{启动运行}
\label{sec-4}

\includegraphics[width=.9\linewidth]{./pic/unityToAndroid_20221123_215517.png}
