...
namespace HotFix.UI {
    ...
    public class ComTetroView : UnityGuiView {
        public override string BundleName {
            get {
                return "ui/view/comtetroview";
            }
        }
        ...
        public override string ViewModelTypeName {
            get {
                return typeof(ComTetroViewModel).FullName;
            }
        }
        public ComTetroViewModel ViewModel {
            get {
                return (ComTetroViewModel)BindingContext;
            }
        }
