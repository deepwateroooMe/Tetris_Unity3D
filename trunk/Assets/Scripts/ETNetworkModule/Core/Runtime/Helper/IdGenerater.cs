...
namespace ET
{
    ...
    public class IdGenerater : IDisposable
    {
        ...
        public IdGenerater()
        {
            ...
            {
                Debug.LogWarning($"lastInstanceIdTime less than 0: {this.lastInstanceIdTime}");
                this.lastInstanceIdTime = 1;
            }
            this.lastIdTime = TimeSince2020();
            if (this.lastIdTime <= 0)
            {
                Debug.LogWarning($"lastIdTime less than 0: {this.lastIdTime}");
                this.lastIdTime = 1;
            }
            this.lastUnitIdTime = TimeSince2020();
            if (this.lastUnitIdTime <= 0)
            {
                Debug.LogWarning($"lastUnitIdTime less than 0: {this.lastUnitIdTime}");
        ...
        public long GenerateInstanceId()
        {
            ...
            else
            {
                ...
                if (this.instanceIdValue > IdGenerater.Mask18bit - 1) // 18bit
                {
                    ...
                    Debug.LogError($"instanceid count per sec overflow: {time} {this.lastInstanceIdTime}");
                }
            }
        ...
        public long GenerateId()
        {
            ...
            else
            {
                ...
                if (value > ushort.MaxValue - 1)
                {
                    ...
                    Debug.LogError($"id count per sec overflow: {time} {this.lastIdTime}");
                }
            }
        ...
        public long GenerateUnitId(int zone)
        {
            ...
            else
            {
                ...
                if (this.unitIdValue > ushort.MaxValue - 1)
                {
                    ...
                    Debug.LogError($"unitid count per sec overflow: {time} {this.lastUnitIdTime}");
                }
            }
