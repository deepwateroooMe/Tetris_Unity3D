...
- 使用与 ET-Network-Module 同样的Unity 版本【确保到时服务器与客户端是可以正常成功通信的】来先把项目能在新的 unity 版本下运行起来【现在仍处在这个步骤】
- trunk.sln 里主程序域里四个项目的整合完整
- Hotfix.sln 里一个热更新项目的构建
- 调试。【我爱爱表哥，爱生活！！！活宝妹就是一定要嫁给亲爱的表哥！！爱表哥，爱生活！！】 
* SDK flow的基本流程设计:
