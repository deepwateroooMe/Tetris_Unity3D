...
// 第一次理解的直觉是对的:枚举器,不是协程
    internal class Adaptor : IEnumerator<object>, CrossBindingAdaptorType {
        ...
        public void Reset() {
            if (_Reset == null) 
n                _Reset = instance.Type.GetMethod("MoveNext", 0);
            if (_Reset != null)
...
\end{minted}
\subsection{Camera: 相机操作相关的逻辑包装}
\label{sec-9-3}
\subsubsection{CameraWrapBase : MonoBehaviour: 具备unity控件生命周期感知能力的抽象基类}
\label{sec-9-3-1}
\begin{minted}[fontsize=\scriptsize,linenos=false]{csharp}
